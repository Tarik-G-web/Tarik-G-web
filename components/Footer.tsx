  ...
  return (
    <footer className="flexCenter pb-14 pt-20 bg-pattern bg-cover bg-center bg-no-repeat">
      <div className="flex flex-col rounded-xl">
        ...
        md:flex-row p-8 bg-primary rounded-t-xl">
        ...
        <p className="regular-14 bg-secondary text-white py-2 px-8
        rounded-b-xl flexBetween"><span> 2024 passport</span><span>All rights reserved</span></p>
      </div>
    </footer>
  );
};
